...
export default function UploadPanel({ onQuestions }: UploadPanelProps) {
  ...
  return (
    <div className=" mx-auto bg-white shadow-2xl rounded-3xl p-8 border border-gray-200 animate-fadeIn">
      ...
      {loading && (
        <div className="mt-6">
          <div className="w-full h-4 bg-gray-200 rounded-full overflow-hidden shadow-inner">
            <div
              className="h-full bg-gradient-to-r from-purple-500 to-purple-700 transition-all duration-700 ease-out"
