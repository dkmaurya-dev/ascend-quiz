...
export default function AdaptiveQuiz({ questions }: QuizProps) {
...
console.log("sections:",sections,"wrong:",wrong,"score:",score,"questions:",questions.length,"percentage:",percentage);
 ...
 function getPercentageScore() {
  console.log(askedIndices.length,score);
  const attemptedQuestions = askedIndices.length-1;
     const totalRightAnswer =+score*4;
     const totalWrongAnswer = (attemptedQuestions - score)*2;
     console.log(totalRightAnswer,totalWrongAnswer);
     const percentageScore = ((totalRightAnswer-totalWrongAnswer)/attemptedQuestions)*100;
...
return (
  <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 bg-yellow shadow-2xl rounded-3xl  border border-blue-200 animate-fadeIn">
...
<div className="my-6">
  <div className="w-full h-5 bg-gray-200 rounded-full overflow-hidden shadow-inner border border-gray-300">
    <div
      className="h-full bg-gradient-r from-blue-500 to-blue-700 transition-all duration-700 ease-out"
